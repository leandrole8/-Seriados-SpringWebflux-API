...
class SeriadosApplicationTests {
	...
	@Test
	public void getOneSeriadoById(){

		webTestClient.get().uri(SERIADOS_ENDPOINT_LOCAL.concat("/{id}"),"10")
				.exchange()
				.expectStatus().isOk()
				.expectBody();
	}
	...
	@Test
	public void getOneSeriadonotFound(){
	...
	@Test
	public void deleteSeriado(){

		webTestClient.delete().uri(SERIADOS_ENDPOINT_LOCAL.concat("/{id}"),"1")
